...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/zsxkib/mmaudio)
...
> **Try it now:** [https://synexa.ai/explore/zsxkib/mmaudio](https://synexa.ai/explore/zsxkib/mmaudio) — the hosted model behind this client. New accounts get a free trial credit.
...
|---|---|---|---|
| [`zsxkib/mmaudio`](https://synexa.ai/explore/zsxkib/mmaudio) | video-to-audio | Add sound to video using the MMAudio V2 model. An advanced AI model that synthesizes high-quality audio from video content, enabling seamless video-to-audio transformation. | $0.01 |
